  ...
  return (
    <>
      ...
      <div className={css(modalContent)}>
        ...
        <h3 className={css(modalHeaderSubTitle)}>Article 2 : Accès au site</h3>
        <div>
          Le site http://www.merci-lartiste.com permet à l'Utilisateur un accès
          gratuit aux services suivants : Le site internet propose les services
          suivants : Informations concernant les tarifs, horaires d'ouverture,
          contacts de Merci l'Artiste. Prises de rendez- vous en ligne pour des
          services liés à la coiffure, la coupe ou la coloration des cheveux et
          de la barbe. Le site est accessible gratuitement en tout lieu à tout
        ...
        <h3 className={css(modalHeaderSubTitle)}>ARTICLE 5 : Responsabilité</h3>
        <div>
          <p>
            Les sources des informations diffusées sur le site
            http://www.merci-lartiste.com sont réputées fiables mais le site ne
            ...
            régulières, le site http://www.merci-lartiste.com ne peut être tenu
            ...
            l’information contenue dans ce site. Le site
            http://www.merci-lartiste.com ne peut être tenu pour responsable
        ...
        <div>
          <p>
            ...
            http://www.merci-lartiste.com. Les cookies ne contiennent pas
            ...
            http://www.merci-lartiste.com. En naviguant sur le site,
            ...
            d’acceptation, l’Utilisateur est informé que certaines
